...
#endif
inline juce::String getBase64()
{
    static juce::String _base64 ("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
    return _base64;
}
...
namespace Util
{
juce::String encode64(juce::MemoryBlock input, int maxLine = 0) ;   //util.encode64 = function(input, maxline)
//{   //{
