...
struct ASN1 : juce::ReferenceCountedObject
{
    ...
    static Ptr create(Class tagClass_,
                      Type type_,
                      bool constructed_,
    ...
    //asn1.create = function(tagClass, type, constructed, value, options)
    {
        ...
        if( value_.empty() && bytes_.getSize() > 0 )
        ...
        //        tagClass: tagClass,
        obj->tagClass = tagClass_;
        //        type: type,
        obj->type = type_;
        //        constructed: constructed,
        obj->constructed = constructed_;
        //        composed: constructed || forge.util.isArray(value),
        obj->composed = constructed_ || !value.empty();
        //        value: value
        obj->value = value_;
        //        };
